...
/* =========================================================================
   Avis clients — C&T Arbro
   Version optimisée : performance, accessibilité et SEO local
============================================================================ */
...
export default function Avis() {
  const reviews = [
    ...
    {
      name: "KooL MaT",
      text: "Service professionnel, ponctuel et travail propre. Arbres morts retirés sans problème.",
      rating: 5,
    },
    {
      name: "P. Latulippe",
  ...
  return (
    <section
      id="avis"
      className="relative py-24 md:py-28 bg-[#f8faf9] overflow-hidden"
    >
      <div className="mx-auto max-w-7xl px-4 md:px-6 text-center">
        ...
        >
          ...
          <p className="mt-3 text-slate-600 text-[15px] max-w-2xl mx-auto leading-relaxed">
            Des clients de <strong>Magog</strong>, <strong>Sherbrooke</strong> et
            partout en <strong>Estrie</strong> nous font confiance pour un service
            <span className="text-emerald-600 font-medium"> professionnel</span>,{" "}
            <span className="text-emerald-600 font-medium">soigné</span> et{" "}
            <span className="text-emerald-600 font-medium">sécuritaire</span>.
          </p>
        </motion.div>
        ...
        >
          <a
            href="https://www.google.com/search?q=Émondage+Arbro+Magog"
            target="_blank"
